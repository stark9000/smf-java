 ...
 * Five tabbed panels, each independent, all wired through AppEventBus.
 *
 * Tabs:
 *   Dashboard  — stats, low stock alerts, live event log
 *   Sales      — browse products, build cart, checkout → bill
 *   Products   — manage product catalog
 *   Customers  — manage customer records
 *   Bills      — view saved invoices
 *
 * This is the completed version of what the original smf-lib
 * NewJFrame + shop/shade was building toward.
 *
 * Every panel:
 *   - Is an EventWatcher subscribed to AppEventBus
 *   - Refreshes itself automatically when data changes
 *   - Uses UIFill for all Swing population (Tutorial 02)
 *   - Uses domain models for all DB operations (Tutorial 05)
 *   - Fires events through AppEventBus (Tutorial 03)
 *
 * None of the panels know about each other.
...
public class MainWindow extends JFrame implements EventWatcher {
    ...
    public MainWindow() {
        super(config.get("app.title", "SMF Shop")
